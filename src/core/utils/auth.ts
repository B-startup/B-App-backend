...
/**
 * Compares a given password with its hashed version using bcrypt
 ...
 * @example
 * const passwordMatches = await comparePassword('StrongPass123!', 'hashedPassword')
 */
 ...
 * @example
 * const encryptedPassword = await cryptPassword('StrongPass123!')
 */
