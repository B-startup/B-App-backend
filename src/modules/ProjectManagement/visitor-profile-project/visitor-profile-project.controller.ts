...
export class VisitorProfileProjectController {
    constructor(
        private readonly visitorProfileProjectService: VisitorProfileProjectService
    ) {}

    @Post()
    create(
        @Body() createVisitorProfileProjectDto: CreateVisitorProfileProjectDto
    ) {
        return this.visitorProfileProjectService.create(
    ...
    update(
        @Param('id') id: string,
        @Body() updateVisitorProfileProjectDto: UpdateVisitorProfileProjectDto
    ) {
        return this.visitorProfileProjectService.update(
            +id,
