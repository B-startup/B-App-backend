...
describe('PostTagService', () => {
    ...
    describe('createAssociation', () => {
        ...
        it('should create association successfully', async () => {
            ...
            (mockPrismaService.post.findUnique as jest.Mock).mockResolvedValue(
                mockPost
            );
            (mockPrismaService.tag.findUnique as jest.Mock).mockResolvedValue(
                mockTag
            );
            (mockPrismaService.postTag.create as jest.Mock).mockResolvedValue(
                mockPostTag
            );
    ...
    describe('addMultipleTagsToPost', () => {
        it('should add multiple tags to post successfully', async () => {
            ...
            const result = await service.addMultipleTagsToPost(
                'test-post-id',
                tagIds
            );
    ...
    describe('findByPost', () => {
        it('should return associations for a post', async () => {
            (mockPrismaService.postTag.findMany as jest.Mock).mockResolvedValue(
                [mockPostTag]
            );
    ...
    describe('removeAssociation', () => {
        it('should remove association successfully', async () => {
            ...
            (mockPrismaService.postTag.delete as jest.Mock).mockResolvedValue(
                mockPostTag
            );
    ...
    describe('findPopularTags', () => {
        it('should return popular tags with post counts', async () => {
            ...
            (mockPrismaService.postTag.groupBy as jest.Mock).mockResolvedValue(
                mockGroupBy
            );
            (mockPrismaService.tag.findMany as jest.Mock).mockResolvedValue(
                mockTags
